...
```bash
cd nanobot/skills/market-intel
...
Maintains the `recent_price_index.json` file. Run this in the background or via cron to keep prices fresh. The strategy monitor (`market-strategy`) also refreshes this automatically.
